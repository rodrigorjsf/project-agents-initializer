...
| 4 | Create Skills (4 artifact types) | Implement `create-skill`, `create-hook`, `create-rule`, `create-subagent` | in-progress | - | 2, 3 | `.claude/PRPs/plans/create-skills-implementation.plan.md` |
