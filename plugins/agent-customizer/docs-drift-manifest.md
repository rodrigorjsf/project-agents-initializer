...
|----------------|-------------|--------|
| `create-hook/references/hook-authoring-guide.md` | `docs/claude-code/hooks/automate-workflow-with-hooks.md` (exit codes ~393-420), `docs/claude-code/hooks/claude-hook-reference-doc.md` (security lines 2050-2065) | baseline |
...
| `improve-hook/references/hook-authoring-guide.md` | `docs/claude-code/hooks/automate-workflow-with-hooks.md` (exit codes ~393-420), `docs/claude-code/hooks/claude-hook-reference-doc.md` (security lines 2050-2065) | baseline |
